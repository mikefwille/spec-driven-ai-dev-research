...
## 8. Obtain permission from user to create or update PR on github

If the user wants you to create the PR

- Create a description for the PR
- Use the gh cli to create the PR
- If you are unable to create the PR, show the user the description in markdown format as a fallback
